...
from apps.cuentas.forms import LoginConOTPForm
...
urlpatterns = [
    path(
        'login/',
        auth_views.LoginView.as_view(template_name='panel/login.html', authentication_form=LoginConOTPForm),
        name='login',
    ),
    path('logout/', auth_views.LogoutView.as_view(), name='logout'),
    path('cuenta/mfa/', views.mfa_configurar, name='mfa_configurar'),
    path('cuenta/mfa/estado/', views.mfa_estado, name='mfa_estado'),
    path('cuenta/mfa/desactivar/', views.mfa_desactivar, name='mfa_desactivar'),
    ...
    path('estaciones/<int:pk>/agente/pausar/', views.estacion_pausar, name='estacion_pausar'),
